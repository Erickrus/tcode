            ...
            while step < max_steps:
                ...
                for tc in tool_calls_this_turn:
                    ...
                    try:
                        ...
                        # Rule denied permission — ToolRunner already updated part state and published tool.failed
                        pass
                    except Exception as e:
                        # ToolRunner already updates part state to error and publishes tool.failed
                        import sys
                        print(f"\033[2m[debug] tool {tool_name} error: {e}\033[0m", file=sys.stderr)
